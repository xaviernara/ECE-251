...
public class RedBall extends JComponent implements ActionListener, MouseMotionListener, KeyListener {
    ...
    private int bally2Speed=21;
    private int ballx2Speed=15;
    public int score = 0;
    public int score1 = 0;
    public int score2=0;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (score>=20){
            ...
            g.fillOval(ballx2,bally2, 30, 30);
        }
        //score	
        ...
        if (score >= 5) {
            ...
            g.drawString(String.valueOf(score + score1+score2), 30 / 1 - 15, 80);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Window down
        if (ballx2 >= paddlex && ballx2 <= paddlex + 100 && bally2 >= 475) {
