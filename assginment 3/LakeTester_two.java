...
public class LakeTester_two {


    public LakeTester_two() {
    }
	...
	//Someone fishes in a lake with capacity 0 (i.e., a dried up lake)
	Fisherperson Xavier = new Fisherperson("Xavier");
	whiteLake.add(new Fish(0, "Sunfish"));
